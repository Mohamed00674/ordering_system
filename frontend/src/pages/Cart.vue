                    ...
                    <div class="col-md-3">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <span>Summary</span>
                                <h3 class="font-bold total-first-price">{{ calculateSummaryPrice()[0] }}DT</h3>

                                <span>Discount</span>
                                <h3 class="font-bold total-discount">{{ calculateSummaryPrice()[1] }}DT</h3>

                                <span>Delivery fee</span>
                                <h3 class="font-bold total-delivery">{{ calculateSummaryPrice()[2] }}DT</h3>

                                <hr />

                                <span>Total</span>
                                <h2 class="font-bold total-sale">{{ calculateSummaryPrice()[3] }}DT</h2>
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +216 99496059</h3>
                                <span class="small">
